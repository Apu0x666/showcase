...
/** @var ViewBase $this */
$this->addVueLoader();
$this->addJs('/modules/LossLog/CoefficientsTechInfo/views/assets/js/vue_script.js', false);

$this->addCss('/modules/LossLog/CoefficientsTechInfo/views/assets/css/style.css', false);
?>
...
<div id="app">
    ...
    <div class="tm-sticky-left">
        <div class="tm-module-buttons">
            <button v-if="permissions.edit || permissions.admin"
                class="tm-btn-rounded" @click="this.$refs.techItemEditModal.newItem();">
                Добавить
            </button>
        </div>
    ...
    <losslog-coefficientstechinfo-item-edit-modal
        ref="techItemEditModal"
